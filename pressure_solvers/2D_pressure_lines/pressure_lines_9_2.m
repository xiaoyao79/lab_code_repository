...
QMAX    = size(v,3);
tol     = 5e-3;          %convergence criterion
...
%             figure(802),imagesc(1100/133.3*pold.',[1100/133.3*pmin 1100/133.3*pmax]),axis image xy,title('old pressure field'),colorbar;
            figure(803),imagesc(1100/133.3*pnew.',[1100/133.3*pmin 1100/133.3*pmax]),axis image xy,title('new pressure field'),colorbar; caxis([-2 2]);

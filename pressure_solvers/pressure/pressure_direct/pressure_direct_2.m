...
%
% Returns p(x,y,t) from u(x,y,t) and v(x,y,t) using a direct backsolve 
...
% using expanded (non-continuity) form of Pressure Poisson equation
% switched to conservative(?) form of N-S equations [ d/dx_i(u_i*u_j) ]

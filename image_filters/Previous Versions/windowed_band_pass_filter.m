function windowed_band_pass_filter(read_directory,write_directory,image_format,sigma_vect,frame_min,frame_max);
...
% lp_sigma=0.02 and hp_sigma=0.08).
%
% The two scalars frame_min and frame_max give the first and last frame in 
% the data sequence to process; these may be neglected to calculate the 
% mean of the entire image sequence. Alternatively to load the entire image
% to the end, frame_max may be set to Inf.

% This extracts the low pass frequency standard devation
lp_sigma=sigma_vect(1);
% This extracts the high pass frequency standard devation

function [p]=pressure_lines_9_2b(x,y,u,v,Re,dt,solver,bcmask,Pref,Px,Py)
...
QMAX    = NT;            %maximum number of iterations per snapshot (overrides convergence)
...
%                              1:ktot,relresg(2:ktot+1),'o-'),legend('residual','1-convergence')
        ...
        pmax = max(max(pnew));
            ...
            figure(803),imagesc(1100/133.3*pold.',[1100/133.3*pmin 1100/133.3*pmax]),axis image xy,title('old pressure field'),colorbar; caxis([-3 3]);
